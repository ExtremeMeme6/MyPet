...
function HomeScreen({navigation, route}) {
    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false} style={{flex: 1, backgroundColor: '#1B1717'}} contentContainerStyle={{alignItems: 'center', display: 'flex', flexDirection: 'column'}}>
        ...
        <Button onPress={() => navigation.navigate("Pet Profile", {token: expoPushToken})} title={'Go To Pet Profile'} style={{height: 50, width: '85%', color: '#1B1717', backgroundColor: "#EEEBDD", fontSize: 17, marginTop: 20, marginBottom: 30}}/>             
      </ScrollView>
  );
}
