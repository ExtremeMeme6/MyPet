...
function RegisterPet({navigation, route}) {
    ...
    return (
      <ScrollView contentContainerStyle={styles.background}>
        ...
        <View style={{width: '85%', alignSelf: 'center', marginTop: 30, height: '8%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
        ...
        <Button onPress={() => handleSubmit()} title={'Register Pet'} style={{height: 50, width: '85%', color: '#1B1717', backgroundColor: "#EEEBDD", fontSize: 17, marginTop: 20, alignSelf: 'center'}}/>
      </ScrollView>
  );
}
